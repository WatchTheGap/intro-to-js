...
let age = currentYear-birthYear;
 ...
 let decades = Math.round((1981-1900)/10);
...
//
 ...
 function madlib(noun1 = "bananas", verb2 = "bananas", verb3 = "bananas", noun4 = "bananas") {
   return "I prefer " + noun1 +" while I " + verb2 +
   " so that I don't " + verb3 + " on the " + noun4 + ".";
 };
